...
import { Row, Col, Card, CardBody, FormGroup, Button, CardTitle, CardSubtitle, Label, Input, Container, FormFeedback, Form } from 'reactstrap';
// Formik validation
...
const FormValidations = () => {
  ...
  const rangeValidation = useFormik({
    ...
    validationSchema: Yup.object().shape({
      ...
      range_Length: Yup.string().required('range between 5 to 10').min(5, 'This value should be between 5 and 10').max(10, 'This value should be between 5 and 10'),
      min_Value: Yup.string()
        .required('Min Value 6')
        .test('val', 'This value should be greater than or equal to 6', (val) => val >= 6),
                    ...
                    <Row>
                      <Col md="4">
                        <FormGroup className="mb-3">
                          ...
                          />
                          {validation.touched.state && validation.errors.state ? <FormFeedback type="invalid">{validation.errors.state}</FormFeedback> : null}
                        </FormGroup>
                      </Col>
                      <Col md="4">
                        <FormGroup className="mb-3">
                          ...
                          />
                          {validation.touched.city && validation.errors.city ? <FormFeedback type="invalid">{validation.errors.city}</FormFeedback> : null}
                        </FormGroup>
                      </Col>
                    ...
                    <Row>
                      <Col md="4">
                        <div className="mb-3 position-relative">
                          ...
                          <div className={validation['fnm'] === true ? 'valid-tooltip' : 'invalid-tooltip'} name="validate" id="validate1">
                      ...
                      <Col md="4">
                        <div className="mb-3 position-relative">
                          ...
                          />
                          <div className={validation['lnm'] === true ? 'valid-tooltip' : 'invalid-tooltip'} name="validate" id="validate2">
                      ...
                      <Col md="4">
                        <div className="mb-3 position-relative">
                          ...
                          <div className="input-group">
                            ...
                            />
                            <div className={validation['unm'] === true ? 'valid-tooltip' : 'invalid-tooltip'} name="validate" id="validate3">
                              {validation['unm'] === true ? 'Looks good!' : 'Please choose a unique and valid username.'}
                            </div>
                          </div>
                        </div>
                      </Col>
                    ...
                    <Row>
                      <Col md="6">
                        <div className="mb-3 position-relative">
                          ...
                          />
                          <div className={validation['city'] === true ? 'valid-tooltip' : 'invalid-tooltip'} name="validate" id="validate4">
                            {validation['city'] === true ? 'Looks good!' : 'Please choose a unique and valid username.Please provide a valid city.'}
                          </div>
                        </div>
                      </Col>
                      <Col md="6">
                        <div className="mb-3 position-relative">
                          ...
                          />
                          <div className={validation['stateV'] === true ? 'valid-tooltip' : 'invalid-tooltip'} name="validate" id="validate5">
              ...
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="mb-3">
                    Parsley is a availity reactstrap validation. It helps you provide your users with feedback on their form submission before sending it to your server.
                  </CardSubtitle>
                  ...
                  >
                    <div className="mb-3">
                      ...
                      />
                      {validationType.touched.username && validationType.errors.username ? <FormFeedback type="invalid">{validationType.errors.username}</FormFeedback> : null}
                    </div>
                    <div className="mb-3">
                      ...
                      />
                      {validationType.touched.password && validationType.errors.password ? <FormFeedback type="invalid">{validationType.errors.password}</FormFeedback> : null}
                    </div>
                    <div className="mb-3">
                      <Input
                        name="password1"
                      ...
                      />
                      {validationType.touched.password1 && validationType.errors.password1 ? <FormFeedback type="invalid">{validationType.errors.password1}</FormFeedback> : null}
                    </div>
                    <div className="mb-3">
                      ...
                      />
                      {validationType.touched.email && validationType.errors.email ? <FormFeedback type="invalid">{validationType.errors.email}</FormFeedback> : null}
                    </div>
                    <div className="mb-3">
                      ...
                      />
                      {validationType.touched.digits && validationType.errors.digits ? <FormFeedback type="invalid">{validationType.errors.digits}</FormFeedback> : null}
                    </div>
                    <div className="mb-3">
                      ...
                      />
                      {validationType.touched.number && validationType.errors.number ? <FormFeedback type="invalid">{validationType.errors.number}</FormFeedback> : null}
                    </div>
                    <div className="mb-3">
                  ...
                  >
                    ...
                    <div className="mb-3">
                      ...
                      <Input
                        ...
                        invalid={rangeValidation.touched.range_Length && rangeValidation.errors.range_Length ? true : false}
                      />
