              ...
              <Card>
                <CardBody>
                  ...
                  <Row className="mb-3">
                    ...
                    <div className="col-md-10">
                      <input className="form-control form-control-color mw-100" type="color" defaultValue="#556ee6" id="example-color-input" />
                    </div>
                  </Row>
                  <Row className="mb-3">
                  ...
                  <Row className="mt-2">
                    <Col lg={6}>
                      <div className="mt-4">
                        ...
                        <p className="card-title-desc">Range inputs have implicit values for min and max—0 and 100, respectively.</p>
                  ...
                  <Row>
                    ...
                    <Col xl={3} sm={6}>
                      <div className="mt-4">
                        ...
                        <p className="sub-header mb-4">
                          Add className <code>.form-checkbox-outline</code> &<code>.form-check-* </code> for a color Checkboxes
                        </p>
                      ...
                      <div className="mt-4">
                        ...
                        <div>
                          <div className="form-check form-radio-outline form-radio-primary mb-3">
                            <input type="radio" id="customRadiooutlinecolor1" name="customRadiooutlinecolor1" className="form-check-input" defaultChecked />
                          ...
                          <div className="form-check form-radio-outline form-radio-success mb-3">
                            <input type="radio" id="customRadiooutlinecolor2" name="customRadiooutlinecolor2" className="form-check-input" defaultChecked />
                          ...
                          <div className="form-check form-radio-outline form-radio-info mb-3">
                            <input type="radio" id="customRadiooutlinecolor3" name="customRadiooutlinecolor3" className="form-check-input" defaultChecked />
                          ...
                          <div className="form-check form-radio-outline form-radio-warning mb-3">
                            <input type="radio" id="customRadiooutlinecolor4" name="customRadiooutlinecolor4" className="form-check-input" defaultChecked />
                          ...
                          <div className="form-check form-radio-outline form-radio-danger mb-3">
                            <input type="radio" id="customRadiooutlinecolor5" name="customRadiooutlinecolor5" className="form-check-input" defaultChecked />
            ...
            <Col lg={12}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    A switch has the markup of a custom checkbox but uses the <code>.form-switch</code> class to render a toggle switch. Switches also support the{' '}
