                            ...
                            <Row>
                              <Col lg="6">
                                <FormGroup className="mb-3">
                                  ...
                                  <Input type="text" className="form-control" id="basicpill-firstname-input12" placeholder="Enter Your First Name" />
                                </FormGroup>
                              </Col>
                              <Col lg="6">
                                <FormGroup className="mb-3">
                                  <Label htmlFor="basicpill-lastname-input22">Last name</Label>
                                  <Input type="text" className="form-control" id="basicpill-lastname-input22" placeholder="Enter Your Last Name" />
                                </FormGroup>
                              </Col>
                            </Row>
                            ...
                            <Row>
                              <Col lg="6">
                                <FormGroup className="mb-3">
                                  ...
                                  <Input type="text" className="form-control" id="basicpill-phoneno-input32" placeholder="Enter Your Phone No." />
                                </FormGroup>
                              </Col>
                              <Col lg="6">
                                <FormGroup className="mb-3">
                                  <Label htmlFor="basicpill-email-input42">Email</Label>
                                  <Input type="email" className="form-control" id="basicpill-email-input42" placeholder="Enter Your Email ID" />
                                </FormGroup>
                              </Col>
                            </Row>
                            <Row>
                              <Col lg="12">
                                <FormGroup className="mb-3">
                                  ...
                                  <textarea id="basicpill-address-input12" className="form-control" rows="2" placeholder="Enter Your Address" />
                                </FormGroup>
                              </Col>
                            </Row>
                          </Form>
                              ...
                              <Row>
                                <Col lg="6">
                                  <FormGroup className="mb-3">
                                    ...
                                    <Input type="text" className="form-control" id="basicpill-pancard-input52" placeholder="Enter Your PAN Card No." />
                                  </FormGroup>
                                </Col>
                                ...
                                <Col lg="6">
                                  <FormGroup className="mb-3">
                                    ...
                                    <Input type="text" className="form-control" id="basicpill-vatno-input62" placeholder="Enter Your VAT/TIN No." />
                                  </FormGroup>
                                </Col>
                              </Row>
                              <Row>
                                <Col lg="6">
                                  <FormGroup className="mb-3">
                                    ...
                                    <Input type="text" className="form-control" id="basicpill-cstno-input72" placeholder="Enter Your CST No." />
                                  </FormGroup>
                                </Col>
                                ...
                                <Col lg="6">
                                  <FormGroup className="mb-3">
                                    ...
                                    <Input type="text" className="form-control" id="basicpill-servicetax-input82" placeholder="Enter Your Service Tax No." />
                                  </FormGroup>
                                </Col>
                              </Row>
                              <Row>
                                <Col lg="6">
                                  <FormGroup className="mb-3">
                                    ...
                                    <Input type="text" className="form-control" id="basicpill-companyuin-input92" placeholder="Company UIN No." />
                                  </FormGroup>
                                </Col>
                                ...
                                <Col lg="6">
                                  <FormGroup className="mb-3">
                                    ...
                                    <Input type="text" className="form-control" id="basicpill-Declaration-input102" placeholder="Declaration Details" />
                                  </FormGroup>
                                </Col>
                              </Row>
                            </Form>
                              ...
                              <Row>
                                <Col lg="6">
                                  <FormGroup className="mb-3">
                                    ...
                                    <Input type="text" className="form-control" id="basicpill-namecard-input112" placeholder="Enter Your Name on Card" />
                                  </FormGroup>
                                </Col>
                              ...
                              <Row>
                                <Col lg="6">
                                  <FormGroup className="mb-3">
                                    ...
                                    <Input type="text" className="form-control" id="basicpill-cardno-input122" placeholder="Enter Your Card Number" />
                                  </FormGroup>
                                </Col>
                                ...
                                <Col lg="6">
                                  <FormGroup className="mb-3">
                                    ...
                                    <Input type="text" className="form-control" id="basicpill-card-verification-input" placeholder="Card Verification Number" />
                                  </FormGroup>
                                </Col>
                              </Row>
                              <Row>
                                <Col lg="6">
                                  <FormGroup className="mb-3">
                                    ...
                                    <Input type="text" className="form-control" id="basicpill-expiration-input132" placeholder="Card Expiration Date" />
                                  </FormGroup>
                                </Col>
                              </Row>
                            </Form>
