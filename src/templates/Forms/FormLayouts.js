                    ...
                    <Row>
                      <Col md={6}>
                        <div className="mb-3">
                          ...
                          <Input type="email" className="form-control" id="formrow-email-Input" placeholder="Enter Your Email ID" />
                        </div>
                      </Col>
                      <Col md={6}>
                        <div className="mb-3">
                    ...
                    <Row>
                      <Col lg={4}>
                        <div className="mb-3">
                          ...
                          <Input type="text" className="form-control" id="formrow-InputCity" placeholder="Enter Your Living City" />
                        </div>
                      </Col>
                      <Col lg={4}>
                        <div className="mb-3">
                      ...
                      <Col lg={4}>
                        <div className="mb-3">
                          ...
                          <Input type="text" className="form-control" id="formrow-InputZip" placeholder="Enter Your Zip Code" />
                        </div>
                      </Col>
                    </Row>
                ...
                <CardBody>
                  ...
                  <Form>
                    ...
                    <Row className="mb-4">
                      ...
                      <Col sm={9}>
                        <Input type="email" className="form-control" id="horizontal-email-Input" placeholder="Enter Your Email ID" />
                      </Col>
                    </Row>
                    <Row className="mb-4">
