                        ...
                        <Row key={key}>
                          ...
                          <Col lg={2} className="align-self-center">
                            <div className="d-grid">
                              <input type="button" className="btn btn-primary" value="Delete" onClick={() => onDeleteFormRow(formRow.id)} />
                            </div>
                          </Col>
                        </Row>
                      ))}
                    </div>
                    <input type="button" className="btn btn-success mt-3 mt-lg-0" value="Add" onClick={() => onAddFormRow()} />
                  </Form>
                </CardBody>
              </Card>
            </Col>
                      ...
                      <div data-repeater-item className="outer">
                        ...
                        <div className="mb-3">
                          ...
                          <div className="form-check form-check-inline">
                            <Input type="radio" id="customRadioInline1" name="customRadioInline1" className="form-check-input" />
                          ...
                          &nbsp;
                          <div className="form-check form-check-inline">
                            <Input type="radio" id="customRadioInline2" name="customRadioInline1" className="form-check-input" />
                        ...
                        <div className="mb-3">
                          ...
                          <Input type="textarea" id="formmessage" className="form-control" rows="3" placeholder="Enter your Message" />
                        </div>
