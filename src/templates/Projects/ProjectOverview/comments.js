            ...
            <div className="me-3">
              {comment.userImg ? (
                ...
                <div className="avatar-xs">
                  <span className="avatar-title rounded-circle bg-soft bg-primary text-primary font-size-16">{comment.username.charAt(0)}</span>
                </div>
              )}
            </div>
                ...
                <div className="d-flex mt-3">
                  <div className="avatar-xs me-3">
                    {comment.reply.userImg ? (
                      ...
                      <span className="avatar-title rounded-circle bg-soft bg-primary text-primary font-size-16">{comment.reply.username.charAt(0)}</span>
                    )}
                  </div>
                  <div className="flex-grow-1">
