...
import { Col, Container, DropdownItem, DropdownMenu, DropdownToggle, Row, Table, UncontrolledDropdown } from 'reactstrap';
                                    ...
                                    <Link to="" className="d-inline-block">
                                      {items.img ? (
                                        ...
                                        <div className="avatar-xs">
                                          <span className={'avatar-title rounded-circle bg-' + items.profileColor + ' text-white' + ' font-size-16'}>{items.profile}</span>
                                        </div>
                                      )}
                                    </Link>
                                  </div>
