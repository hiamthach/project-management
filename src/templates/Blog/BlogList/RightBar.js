          ...
          <CardBody className="p-4">
            ...
            <div>
              ...
              <ul className="list-unstyled fw-medium">
                ...
                <li>
                  <Link to="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right me-1"></i> Development <span className="badge badge-soft-success rounded-pill float-end ms-1 font-size-12">04</span>
                  </Link>
                </li>
                <li>
                  <Link to="#" className="text-muted py-2 d-block">
            ...
            <div>
              ...
              <ul className="list-unstyled fw-medium">
                <li>
                  <Link to="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right me-1"></i> 2020 <span className="badge badge-soft-success rounded-pill float-end ms-1 font-size-12">03</span>
                  </Link>
                </li>
                <li>
                  <Link to="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right me-1"></i> 2019 <span className="badge badge-soft-success rounded-pill float-end ms-1 font-size-12">06</span>
                  </Link>
                </li>
                <li>
                  <Link to="#" className="text-muted py-2 d-block">
                    <i className="mdi mdi-chevron-right me-1"></i> 2018 <span className="badge badge-soft-success rounded-pill float-end ms-1 font-size-12">05</span>
                  </Link>
                </li>
              </ul>
            </div>
