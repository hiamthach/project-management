                              ...
                              <blockquote className="p-4 border-light border rounded mb-4">
                                <div className="d-flex">
                                  ...
                                  <div>
                                    <p className="mb-0">
                                      {' '}
                                      At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium deleniti atque corrupti quos dolores et quas molestias
                                      excepturi sint quidem rerum facilis est
                                    </p>
                                  </div>
                                </div>
                              </blockquote>
