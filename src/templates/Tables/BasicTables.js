              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    For basic styling—light padding and only horizontal dividers—add the base className <code>.table</code> to any
                    <code>&lt;table&gt;</code>.
                  </p>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  <h4 className="card-title">Table Border color</h4>
                  <p className="card-title-desc">
                    Add <code>.table-bordered</code> & <code>.border-*</code> for colored borders on all sides of the table and cells.
                  </p>
              ...
              <Card>
                <CardBody>
                  <div className="table-responsive">
                    ...
                    <p className="card-title-desc">
                      Table cells in <code>&lt;tbody&gt;</code> inherit their alignment from <code>&lt;table&gt;</code> and are aligned to the the top by default. Use the vertical
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="card-title-desc">Use contextual className to color table rows or individual cells.</CardSubtitle>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="card-title-desc">
                    A <code>&lt;caption&gt;</code> functions like a heading for a table. It helps users with screen readers to find a table and understand what it’s about and
