...
import { addMessage as onAddMessage, getChats as onGetChats, getContacts as onGetContacts, getGroups as onGetGroups, getMessages as onGetMessages } from 'store/actions';
                                      ...
                                      <div className="d-flex">
                                        ...
                                        {chat.isImg ? (
                                          <div className="avatar-xs align-self-center me-3">
                                            <span className="avatar-title rounded-circle bg-primary bg-soft text-primary">{chat.profile}</span>
                                          </div>
                                        ) : (
                                          <div className="align-self-center me-3">
                                ...
                                groups.map((group) => (
                                  <li key={'test' + group.image}>
                                    <Link
                                      to="#"
                                      onClick={() => {
                                        userChatOpen(group.id, group.name, group.status, Math.floor(Math.random() * 100));
                                      }}
                                    >
                                      <div className="d-flex align-items-center">
                                        <div className="avatar-xs me-3">
                                          <span className="avatar-title rounded-circle bg-primary bg-soft text-primary">{group.image}</span>
                                        </div>
                                ...
                                contacts.map((contact) => (
                                  <div key={'test_' + contact.category} className={contact.category === 'A' ? '' : 'mt-4'}>
                                    <div className="avatar-xs mb-3">
                                      <span className="avatar-title rounded-circle bg-primary bg-soft text-primary">{contact.category}</span>
                                    </div>
                                      ...
                                      {contact.child.map((array) => (
                                        <li key={'test' + array.id}>
                                          <Link
                                            to="#"
                                            onClick={() => {
                                              userChatOpen(array.id, array.name, array.status, Math.floor(Math.random() * 100));
                                            }}
                                          >
                          ...
                          <PerfectScrollbar style={{ height: '470px' }} containerRef={(ref) => setMessageBox(ref)}>
                            ...
                            {messages &&
                              map(messages, (message) => (
                                <li key={'test_k' + message.id} className={message.sender === currentUser.name ? 'right' : ''}>
