            ...
            <Card className="mini-stats-wid">
              ...
              {item.istrendingArrow ? (
                <div className="card-body border-top py-3">
                  <p className="mb-0">
                    {' '}
                    <span className={'badge badge-soft-' + item.bagdeColor + ' me-2'}>
                      <i className="bx bx-trending-down align-bottom me-1"></i> {item.perstangeValue}%
                    </span>
                    Decrease last month
                  </p>
                </div>
                ...
                <div className="card-body border-top py-3">
                  <p className="mb-0">
                    {' '}
                    <span className={'badge badge-soft-' + item.bagdeColor + ' me-2'}>
                      <i className="bx bx-trending-up align-bottom me-1"></i> {item.perstangeValue}%
                    </span>
                    Increase last month
                  </p>
                </div>
