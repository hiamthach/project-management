...
const JobWidgetCharts = ({ dataColors, series }) => {
  ...
  return (
    <React.Fragment>
      <ReactApexChart options={options} series={series} type="area" height="46" width="130" className="apex-charts" />
    </React.Fragment>
  );
};
...
const ReceivedTimeCharts = ({ dataColors }) => {
  ...
  return (
    <React.Fragment>
      <ReactApexChart options={options} series={series} type="line" height="378px" width="456px" className="apex-charts" />
    </React.Fragment>
  );
};
