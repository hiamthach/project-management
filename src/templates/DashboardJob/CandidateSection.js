                  ...
                  <div className="carousel-item active" data-bs-interval="3000">
                    ...
                    <div className="bg-light p-3 d-flex">
                      ...
                      <div className="flex-grow-1">
                        ...
                        <p className="mb-0 text-muted">
                          <i className="bx bx-map text-body align-middle"></i> Cambodia
                        </p>
                      </div>
                      <div>
                        <UncontrolledDropdown>
                  ...
                  <div className="carousel-item active" data-bs-interval="3000">
                    ...
                    <div className="bg-light p-3 d-flex">
                      ...
                      <div className="flex-grow-1">
                        ...
                        <p className="mb-0 text-muted">
                          <i className="bx bx-map text-body align-middle"></i> Belgium
                        </p>
                      </div>
                      <div>
                        <UncontrolledDropdown>
                  ...
                  <div className="carousel-item active" data-bs-interval="3000">
                    ...
                    <div className="bg-light p-3 d-flex">
                      ...
                      <div className="flex-grow-1">
                        ...
                        <p className="mb-0 text-muted">
                          <i className="bx bx-map text-body align-middle"></i> San Marino
                        </p>
                      </div>
                      <div>
                        <UncontrolledDropdown>
