              ...
              <ul className="verti-timeline list-unstyled">
                ...
                <li className="event-list">
                  ...
                  <div className="d-flex">
                    <div className="flex-shrink-0 me-3">
                      <div className="avatar-xs">
                        <div className="avatar-title bg-primary text-primary bg-soft rounded-circle">JA</div>
                      </div>
                    </div>
                    <div className="flex-grow-1">
                      <div>
                        <b>Jennifer Alexandar</b> created a new account as a <b>Freelance</b>.<p className="text-muted mb-0">1 hrs ago</p>
                      </div>
                    </div>
                  </div>
                </li>
                ...
                <li className="event-list">
                  ...
                  <div className="d-flex">
                    <div className="flex-shrink-0 me-3">
                      <div className="avatar-xs">
                        <div className="avatar-title bg-primary text-primary bg-soft rounded-circle">AZ</div>
                      </div>
                    </div>
                    <div className="flex-grow-1">
                      <div>
                        <b>Acolin Zelton</b> created a new account as a <b>Freelance</b>.<p className="text-muted mb-0">1 hrs ago</p>
                      </div>
                    </div>
                  </div>
                </li>
