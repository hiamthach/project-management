          ...
          <div className="d-flex flex-column h-100">
            <div className="mb-4">
              ...
              <ul className="list-unstyled categories-list">
                <li>
                  <div className="custom-accordion">
                    <Link className="text-body fw-medium py-1 d-flex align-items-center" onClick={toggle} to="#">
                      ...
                      <i className={isOpen ? 'mdi mdi-chevron-up accor-down-icon ms-auto' : 'mdi mdi-chevron-down accor-down-icon ms-auto'} />
                    </Link>
                ...
                <li>
                  <Link to="#" className="text-body d-flex align-items-center">
                    <i className="mdi mdi-cog text-muted font-size-16 me-2"></i> <span className="me-auto">Setting</span>
