        ...
        {map(mails, (mail, index) => (
          <li key={index}>
            <div className="col-mail col-mail-1">
              ...
              <span onClick={() => makeFav(mail.id)} className={mail.fav === true ? 'star-toggle fas fa-star' : 'star-toggle far fa-star'} />
            </div>
            <div className="col-mail col-mail-2">
              <Link to="#" className="subject">
                Hello – <span className="teaser">Trip home from Colombo has been arranged, then Jenna will come get me from Stockholm. :)</span>
              </Link>
