...
import { Button, Card, Col, Container, Input, Label, Row, TabContent, TabPane, Nav, Modal, ModalBody, ModalFooter, ModalHeader, NavItem, NavLink } from 'reactstrap';
...
const EmailInbox = (props) => {
  ...
  const { inboxmails, starredmails, importantmails, trashmails, draftmails, sentmails } = useSelector((state) => ({
