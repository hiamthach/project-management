                          ...
                          <td>
                            <div className="avatar-group">
                              ...
                              <div className="avatar-group-item">
                                <Link to="#" className="d-inline-block">
                                  <div className="avatar-xs">
                                    <span className="avatar-title rounded-circle bg-warning text-white font-size-16">R</span>
                                  </div>
                                </Link>
                              </div>
                              <div className="avatar-group-item">
                          ...
                          <td>
                            <div className="avatar-group">
                              ...
                              <div className="avatar-group-item">
                                <Link to="#" className="d-inline-block">
                                  <div className="avatar-xs">
                                    <span className="avatar-title rounded-circle bg-danger text-white font-size-16">K</span>
                                  </div>
                                </Link>
                              </div>
                              <div className="avatar-group-item">
                          ...
                          <td>
                            <div className="avatar-group">
                              ...
                              <div className="avatar-group-item">
                                <Link to="#" className="d-inline-block">
                                  <div className="avatar-xs">
                                    <span className="avatar-title rounded-circle bg-info text-white font-size-16">D</span>
                                  </div>
                                </Link>
                              </div>
                            </div>
                          ...
                          <td>
                            <div className="avatar-group">
                              ...
                              <div className="avatar-group-item">
                                <Link to="#" className="d-inline-block">
                                  <div className="avatar-xs">
                                    <span className="avatar-title rounded-circle bg-danger text-white font-size-16">P</span>
                                  </div>
                                </Link>
                              </div>
                            </div>
