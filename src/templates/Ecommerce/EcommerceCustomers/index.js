...
// Column
import { UserName, PhoneEmail, Address, Rating, WalletBalances, JoiningDate } from './EcommerceCustCol';
                          ...
                          <Col className="col-12">
                            ...
                            <div className="mb-3">
                              ...
                              <Input
                                ...
                                invalid={validation.touched.rating && validation.errors.rating ? true : false}
                              />
                              {validation.touched.rating && validation.errors.rating ? <FormFeedback type="invalid">{validation.errors.rating}</FormFeedback> : null}
                            </div>
                            ...
                            <div className="mb-3">
                              ...
                              <Input
                                ...
                                invalid={validation.touched.walletBalance && validation.errors.walletBalance ? true : false}
                              />
                            ...
                            <div className="mb-3">
                              ...
                              />
                              {validation.touched.joiningDate && validation.errors.joiningDate ? <FormFeedback type="invalid">{validation.errors.joiningDate}</FormFeedback> : null}
                            </div>
                          </Col>
                        </Row>
                        <Row>
