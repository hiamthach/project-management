...
//Import actions
import { getProductDetail as onGetProductDetail, getProductComments, onAddReply as onAddReplyAction, onAddComment as onAddCommentAction } from 'store/actions';
...
const EcommerceProductDetail = (props) => {
  ...
  const onClickReply = (commentId) => {
    ...
    const commentIdx = (modifiedComments || []).findIndex((comment) => comment.commentId.toString() === commentId.toString());
    if (commentIdx > -1) {
                          ...
                          <Row>
                            ...
                            <Col md={7} sm={9} className="offset-md-1 col-8">
                              <TabContent activeTab={activeTab}>
                                <TabPane tabId="1">
                                  <div>
                                    <img src={productImages[product.image]} alt="" id="expandedImg1" className="img-fluid mx-auto d-block" />
                                  </div>
                                </TabPane>
                                <TabPane tabId="2">
                                  <div>
                                    <img src={productImages[product.image]} id="expandedImg2" alt="" className="img-fluid mx-auto d-block" />
                                  </div>
                                </TabPane>
                                <TabPane tabId="3">
                                  <div>
                                    <img src={productImages[product.image]} id="expandedImg3" alt="" className="img-fluid mx-auto d-block" />
                                  </div>
                                </TabPane>
                                <TabPane tabId="4">
                                  <div>
                                    <img src={productImages[product.image]} id="expandedImg4" alt="" className="img-fluid mx-auto d-block" />
                                  </div>
                                </TabPane>
                              </TabContent>
                      ...
                      <Col xl="6">
                        <div className="mt-4 mt-xl-3">
                          ...
                          <div className="text-muted float-start me-3">
                            <StarRatings rating={4} starRatedColor="#F1B44C" starEmptyColor="#74788d" numberOfStars={5} name="rating" starDimension="14px" starSpacing="3px" />
                          </div>
