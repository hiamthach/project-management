                    ...
                    <Row>
                      <Col sm="6">
                        <div className="mb-3">
                          ...
                          <Input id="productname" name="productname" type="text" className="form-control" placeholder="Product Name" />
                        </div>
                        <div className="mb-3">
                          <Label htmlFor="manufacturername">Manufacturer Name</Label>
                          <Input id="manufacturername" name="manufacturername" type="text" className="form-control" placeholder="Manufacturer Name" />
                        </div>
                        <div className="mb-3">
                          <Label htmlFor="manufacturerbrand">Manufacturer Brand</Label>
                          <Input id="manufacturerbrand" name="manufacturerbrand" type="text" className="form-control" placeholder="Manufacturer Brand" />
                        </div>
                        <div className="mb-3">
                          <Label htmlFor="price">Price</Label>
                          <Input id="price" name="price" type="text" className="form-control" placeholder="Price" />
                        </div>
                      </Col>
                      ...
                      <Col sm="6">
                        ...
                        <div className="mb-3">
                          ...
                          <textarea className="form-control mb-3" id="productdesc" rows="5" placeholder="Product Description" />
                        </div>
                      </Col>
                    </Row>
                    ...
                    <Row>
                      <Col sm={6}>
                        <div className="mb-3">
                          ...
                          <Input id="metatitle" name="productname" type="text" className="form-control" placeholder="Metatitle" />
                        </div>
                        <div className="mb-3">
                          <Label htmlFor="metakeywords">Meta Keywords</Label>
                          <Input id="metakeywords" name="manufacturername" type="text" className="form-control" placeholder="Meta Keywords" />
                        </div>
                      </Col>
                      ...
                      <Col sm={6}>
                        <div className="mb-3">
                          ...
                          <textarea className="form-control" id="metadescription" rows="5" placeholder="Meta Description" />
                        </div>
                      </Col>
                    </Row>
                    <div className="d-flex flex-wrap gap-2">
