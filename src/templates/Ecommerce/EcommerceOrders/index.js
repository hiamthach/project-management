...
import { OrderId, BillingName, Date, Total, PaymentStatus, PaymentMethod } from './EcommerceOrderCol';
        ...
        <div className="container-fluid">
          ...
          <Row>
            <Col xs="12">
              <Card>
                <CardBody>
                  <TableContainer columns={columns} data={orders} isGlobalFilter={true} isAddOptions={true} handleOrderClicks={handleOrderClicks} customPageSize={10} />
                </CardBody>
              </Card>
            </Col>
          </Row>
                ...
                <Row>
                  <Col className="col-12">
                    ...
                    <div className="mb-3">
                      ...
                      />
                      {validation.touched.billingName && validation.errors.billingName ? <FormFeedback type="invalid">{validation.errors.billingName}</FormFeedback> : null}
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                      ...
                      {validation.touched.paymentStatus && validation.errors.paymentStatus ? <FormFeedback type="invalid">{validation.errors.paymentStatus}</FormFeedback> : null}
                    </div>
                    <div className="mb-3">
