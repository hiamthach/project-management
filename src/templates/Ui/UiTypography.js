            ...
            <Col xl={6}>
              ...
              <Card>
                <CardBody>
                  ...
                  <h1 className="mb-3">
                    h1. Bootstrap heading <small className="text-muted">2.03125rem (32.5px)</small>
                  </h1>
                  <h2 className="mb-3">
                    h2. Bootstrap heading <small className="text-muted">1.625rem (26px)</small>
                  </h2>
                  <h3 className="mb-3">
                    h3. Bootstrap heading <small className="text-muted">1.42188rem (22.75px)</small>
                  </h3>
                  <h4 className="mb-3">
                    h4. Bootstrap heading <small className="text-muted">1.21875rem (19.5px)</small>
                  </h4>
                  <h5 className="mb-3">
                    h5. Bootstrap heading <small className="text-muted">1.01563rem (16.25)</small>
                  </h5>
                  <h6>
                    h6. Bootstrap heading <small className="text-muted">0.8125rem (13px)</small>
                  </h6>
                </CardBody>
              </Card>
              <Card>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Remove the default <code className="highlighter-rouge">list-style</code> and left margin on list items (immediate children only).{' '}
                    <strong>This only applies to immediate children list items</strong>, meaning you will need to add the className for any nested lists as well.
                  </p>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Remove a list’s bullets and apply some light <code className="highlighter-rouge">margin</code> with a combination of two classes,{' '}
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    <code className="highlighter-rouge">&lt;blockquote className=&quot;blockquote&quot;&gt;</code> around any <abbr title="HyperText Markup Language">HTML</abbr> as
                    the quote.
                  </p>
                  <Row>
                    <Col xs="6">
            ...
            <Col className="col-12">
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Align terms and descriptions horizontally by using our grid system’s predefined classNamees (or semantic mixins). For longer terms, you can optionally add a{' '}
                    <code className="highlighter-rouge">.text-truncate</code> className to truncate the text with an ellipsis.
                  </p>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Use <code>.text-lowercase</code>, <code>.text-uppercase</code>, or <code>.text-capitalize</code> to transform the text..
                  </p>
                  <div>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    <code>font-style</code> utilities are abbreviated as <code>.fst-*</code> and <code>font-weight</code> utilities are abbreviated as <code>.fw-*</code>.
                  </p>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <div>
                    <p className="lh-1">
                      This is a long paragraph written to show how the line-height of an element is affected by our utilities. Classes are applied to the element itself or
                      sometimes the parent element. These classes can be customized as needed with our utility API.
                    </p>
                    <p className="lh-sm">
                      This is a long paragraph written to show how the line-height of an element is affected by our utilities. Classes are applied to the element itself or
                      sometimes the parent element. These classes can be customized as needed with our utility API.
