...
import { Row, Col, Card, CardBody, CardTitle, Modal, Container, ModalHeader, ModalBody, ModalFooter } from 'reactstrap';
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Modals are streamlined, but flexible dialog prompts powered by JavaScript. They support a number of use cases from user notification to completely custom
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div className="modal-body">
                        ...
                        <p>
                          Aenean lacinia bibendum nulla sed consectetur. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec sed odio dui. Donec ullamcorper
                  ...
                  <div>
                    ...
                    >
                      <div className="modal-header">
                        ...
                        <button type="button" onClick={() => setmodal_scroll(false)} className="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      <div className="modal-body">
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Modal of buttons that all trigger the same modal with slightly different contents. Use <code>event.relatedTarget</code> and HTML <code>data-bs-target</code>{' '}
