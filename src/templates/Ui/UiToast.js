...
import { Row, Col, Card, CardBody, Container, Button, Toast, ToastHeader, ToastBody, CardTitle } from 'reactstrap';
              ...
              <Card>
                <CardBody>
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    <div>
                      <Button type="button" color="primary" id="liveToastBtn" onClick={toggleToast}>
                        Show live toast
                      </Button>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Toasts are as flexible as you need and have very little required markup. At a minimum, we require a single element to contain your “toasted” content and
                  ...
                  <div style={{ minHeight: '110px' }}>
                    <Toast isOpen={toast2} role="alert">
                      <ToastHeader toggle={() => setToast2(!toast2)}>
                        ...
                        <small style={{ marginLeft: '165px' }} className="text-muted">
                          11 mins ago
                        </small>
                      </ToastHeader>
                      <ToastBody>Hello, world! This is a toast message.</ToastBody>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Toasts are slightly translucent, too, so they blend over whatever they might appear over. For browsers that support the <code>backdrop-filter</code> CSS
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">For systems that generate more notifications, consider using a wrapping element so they can easily stack.</p>
                      ...
                      <div className="toast-container position-absolute top-0 end-0 p-2 p-lg-3">
                        <Toast isOpen={toast4} role="alert">
                          <ToastHeader toggle={() => setToast4(!toast4)}>
                            <img src={logo} alt="" className="me-2" height="18" />
                            <strong className="me-auto">Skote</strong>
                            <small style={{ marginLeft: '175px' }} className="text-muted">
                              just now
                            </small>
                          </ToastHeader>
                        ...
                        <Toast isOpen={toast5} role="alert">
                          <ToastHeader toggle={() => setToast5(!toast5)}>
                            <img src={logo} alt="" className="me-2" height="18" />
                            <strong className="me-auto">Skote</strong>
                            <small style={{ marginLeft: '167px' }} className="text-muted">
                              2 sec ago
                            </small>
                          </ToastHeader>
              ...
              <Card>
                <CardBody>
                  ...
                  <div className="d-flex flex-column gap-3">
                    ...
                    <Toast isOpen={toast7} className="align-items-center fade show" role="alert">
                    ...
                    <div aria-live="polite" aria-atomic="true">
                      <Toast isOpen={toast8} className="align-items-center text-white bg-primary border-0" role="alert">
                        <div className="d-flex">
                          <ToastBody>Hello, world! This is a toast message.</ToastBody>
                          <button onClick={() => setToast8(false)} type="button" className="btn-close btn-close-white me-2 m-auto"></button>
                        </div>
                      </Toast>
                    </div>
                  </div>
