              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Any single <code className="highlighter-rouge">.btn</code> can be turned into a dropdown toggle with some markup changes. Here’s how you can put them to work
                    with either <code className="highlighter-rouge">&lt;button&gt;</code> elements:
                  </p>
                  <Row>
                    <Col sm={6}>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="mb-4">The best part is you can do this with any button variant, too:</CardSubtitle>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Opt into darker dropdowns to match a dark navbar or custom style by adding <code>.dropdown-menu-dark</code> onto an existing <code>.dropdown-menu</code>. No
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Add <code className="highlighter-rouge">.dropdown-menu-end</code> to a <code className="highlighter-rouge">.dropdown-menu</code> to right align the dropdown
                    menu.
                  </p>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    By default, the dropdown menu is closed when clicking inside or outside the dropdown menu. You can use the <code>autoClose</code> option to change this behavior
                    of the dropdown.
                  </p>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <div className="d-flex gap-2 flex-wrap">
                    <Dropdown className="dropup" isOpen={dropup1} direction="up" toggle={() => setDropup1(!dropup1)}>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <div className="d-flex gap-2 flex-wrap">
                    <Dropdown isOpen={info_dropup111} direction="left" className="btn-group dropstart" toggle={() => setInfo_dropup111(!info_dropup111)}>
                      <DropdownToggle className="btn btn-info">
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <div className="d-flex gap-2 flex-wrap">
                    <Dropdown isOpen={info_dropup1} direction="right" className="btn-group dropend" toggle={() => setInfo_dropup1(!info_dropup1)}>
                    ...
                    <ButtonDropdown direction="right" isOpen={infodrp_up11} className="btn-group dropend" toggle={() => setInfodrp_up11(!infodrp_up11)}>
                      <Button id="caret" color="info">
                        Split dropright
                      </Button>
