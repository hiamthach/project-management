                  ...
                  <Row>
                    ...
                    <Col lg={6}>
                      ...
                      <p className="card-title-desc">
                        Use the <code>.rounded-pill</code> modifier className to make badges more rounded (with a larger <code>border-radius</code>
                ...
                <CardBody>
                  ...
                  <Row>
                    ...
                    <Col lg={6}>
                      ...
                      <CardSubtitle className="mb-3">
                        Pagination links are customizable for different circumstances. Use <code>.disabled</code> for links that appear un-clickable and <code>.active</code> to
                  ...
                  <Row>
                    ...
                    <Col lg={6}>
                      ...
                      <CardSubtitle className="mb-3">Change the alignment of pagination components with flexbox utilities.</CardSubtitle>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Provide an option to dismiss or close a component with <code>.btn-close</code>. Default styling is limited, but highly customizable. Modify the Sass variables
                    to replace the default <code>background-image</code>. <strong>Be sure to include text for screen readers</strong>, as we’ve done with <code>aria-label</code>.
                  </p>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Disabled close buttons change their <code>opacity</code>. We’ve also applied <code>pointer-events: none</code> and <code>user-select: none</code> to preventing
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Change the default <code>.btn-close</code> to be white with the <code>.btn-close-white</code> class. This class uses the <code>filter</code> property to invert
