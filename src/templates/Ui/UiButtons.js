              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Replace the default modifier classes with the <code className="highlighter-rouge">.btn-outline-*</code> ones to remove all background images and colors on any
                    button.
                  </p>
                  <div className="d-flex flex-wrap gap-2">
              ...
              <Card>
                <CardBody>
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    ...
                    <Button type="button" className="btn btn-soft-secondary waves-effect waves-light">
                      Secondary
                    </Button>
                    ...
                    <Button type="button" className="btn btn-soft-dark waves-effect waves-light">
                      Dark
                    </Button>
                  </div>
                </CardBody>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Add <code>.w-xs</code>, <code>.w-sm</code>, <code>.w-md</code> and <code> .w-lg</code> className for additional buttons width.
                  </p>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    classes are designed to be used with the <code className="highlighter-rouge">&lt;button&gt;</code> element. However, you can also use these classes on{' '}
                    <code className="highlighter-rouge">&lt;Link&gt;</code> or <code className="highlighter-rouge">&lt;input&gt;</code> elements (though some browsers may apply a
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Add <code className="highlighter-rouge">data-toggle=&quot;button&ldquo;</code>
                    ...
                    <strong>and</strong> <code className="highlighter-rouge">aria-pressed=&quot;true&ldquo;</code> to the
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Create block level buttons—those that span the full width of a parent—by adding <code className="highlighter-rouge">.btn-block</code>.
                  </p>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    <code className="highlighter-rouge">data-toggle=&quot;buttons&ldquo;</code> to a<code className="highlighter-rouge">.btn-group</code> containing those modified
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Wrap a series of buttons with <code className="highlighter-rouge">.btn</code> in <code className="highlighter-rouge">.btn-group</code>.
                  </p>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Combine sets of button groups into button toolbars for more complex components.Use utility className as needed to space out groups, buttons, and more.
                  </p>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Instead of applying button sizing classes to every button in a group, just add <code className="highlighter-rouge">.btn-group-*</code> to each{' '}
                    <code className="highlighter-rouge">.btn-group</code>, including each one when nesting multiple groups.
                  </p>
                  <div className="d-flex flex-wrap gap-3">
