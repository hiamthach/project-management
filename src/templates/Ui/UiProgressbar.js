            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    We only set a <code className="highlighter-rouge">height</code> value on the <code className="highlighter-rouge">.progress-bar</code>, so if you change that
                    value the outer <code className="highlighter-rouge">.progress</code> will automatically resize accordingly.
                  </p>
                  <div>
                    <div className="mb-4">
                      <h5 className="font-size-13">Progress sm</h5>
                      <Progress value={25} color="primary" className="progress-sm"></Progress>
                    </div>
                    <div className="mb-4">
                      <h5 className="font-size-13">Progress md</h5>
                      <Progress value={40} color="success" className="progress-md"></Progress>
                    </div>
                    <div className="mb-4">
                      <h5 className="font-size-13">Progress lg</h5>
                      <Progress value={50} color="warning" className="progress-lg"></Progress>
                    </div>
                    <div>
                      <h5 className="font-size-13">Progress xl</h5>
                      <Progress value={70} color="danger" className="progress-xl"></Progress>
                    </div>
                  </div>
                </CardBody>
              </Card>
            ...
            <Col xl={6}>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    The striped gradient can also be animated. Add <code>.progress-bar-animated</code> to <code>.progress-bar</code> to animate the stripes right to left via CSS3
                    animations.
                  </p>
                  <div>
                    <Progress value={75} color="primary" style={{ width: '75%' }} animated></Progress>
                  </div>
                </CardBody>
              </Card>
            </Col>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc mb-4">Example of Custom progress</p>
                  <div>
                ...
                <CardBody>
                  ...
                  <div className="mt-5">
                    <div className="position-relative m-4">
                      <Progress value={50} color="primary" style={{ height: '1px' }}></Progress>
