...
import { Alert, Col, Row, Card, CardBody, CardTitle, UncontrolledAlert, Container } from 'reactstrap';
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Alerts are available for any length of text, as well as an optional dismiss button. For proper styling, use one of the four <strong>required</strong> contextual
                    classes (e.g., <code>.alert-success</code>). For inline dismissal, use the alerts jQuery plugin.
                  </p>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Use the <code className="highlighter-rouge">.alert-link</code> utility className quickly provide matching colored links within any alert.
                  </p>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Add a dismiss button and the <code>.alert-dismissible</code> class, which adds extra padding to the right of the alert and positions the <code>.btn-close</code>{' '}
                    button.
                  </p>
              ...
              <Card>
                <CardBody>
                  ...
                  <div className="">
                    ...
                    <button type="button" className="btn btn-primary" onClick={() => setShow(true)} id="liveAlertBtn">
                      Show live alert
                    </button>
                  </div>
                </CardBody>
