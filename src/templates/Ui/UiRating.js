                  ...
                  <Row>
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <div className="d-flex justify-content-center align-items-center">
                          <Rating max={5} initialRating emptySymbol="mdi mdi-star-outline text-muted" fullSymbol="mdi mdi-star text-primary" className="rating-symbol-background" />
                        </div>
                      </div>
                    </Col>
                    ...
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <Rating
                          ActiveComponent={<i className="mdi mdi-star text-primary rating-symbol-background" style={starStyle} />}
                          InActiveComponent={<i className="mdi mdi-star-outline text-muted" style={starStyle} />}
                          readonly={true}
                        />
                      </div>
                    </Col>
                    ...
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        <h5 className="font-size-15">Readonly rating with a value</h5>
                        <Rating
                          stop={5}
                          emptySymbol="mdi mdi-star-outline text-primary "
                          fullSymbol="mdi mdi-star text-primary "
                    ...
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <Rating
                          ...
                          ActiveComponent={<i className="mdi mdi-star text-primary" style={starStyle} />}
                          InActiveComponent={<i className="mdi mdi-star-outline text-muted" style={starStyle} />}
                        />
                      </div>
                    </Col>
