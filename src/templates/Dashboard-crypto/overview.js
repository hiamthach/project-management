            ...
            <div>
              <div id="overview-chart" className="apex-charts" dir="ltr">
                <div className="toolbar d-flex flex-wrap gap-2 justify-content-center">
                  <Button color="light" size="sm" type="button" className={activeM ? 'active' : ''} onClick={() => updateChartMonthly()} id="one_month">
                    1M
                  </Button>
                  <Button color="light" size="sm" type="button" className={active6M ? 'active' : ''} onClick={() => updateChartSixMonth()} id="six_months">
                    6M
                  </Button>
                  <Button color="light" size="sm" type="button" className={activeY ? 'active' : ''} onClick={() => updateChartYearly()} id="one_year">
                    1Y
                  </Button>
                  <Button color="light" size="sm" type="button" className={activeA ? 'active' : ''} onClick={() => updateChartAll()} id="all">
                    ALL
                  </Button>
                </div>
