          ...
          <CardBody className="p-4">
            <div className="d-flex">
              ...
              <div className="flex-shrink-0 ms-3">
                <i className={'bx ' + props.pricing.icon + ' h1 text-primary'} style={{ lineHeight: 1 }} />
              </div>
            </div>
            <div className="py-4">
              <h2>
            ...
            <div className="text-center plan-btn">
              <Link to={props.pricing.link} className="btn btn-primary btn-sm waves-effect waves-light ">
                Sign up Now
              </Link>
            </div>
