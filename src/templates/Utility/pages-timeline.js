              ...
              <Card>
                <CardBody>
                  ...
                  <div className="hori-timeline">
                    ...
                    >
                      <SwiperSlide className="item event-list" style={{ display: 'inline-table' }}>
                        <div>
                      ...
                      {statuses.map((status, key) => (
                        <li key={key} className="event-list">
                          <div className="event-timeline-dot">
                            <i className={status.id === 3 ? 'bx bx-right-arrow-circle bx-fade-right' : 'bx bx-right-arrow-circle'} />
                          </div>
