...
import { Card, CardBody, Col, Container, Row, Modal, ModalHeader, ModalBody, Label, FormFeedback, UncontrolledTooltip, Input, Form } from 'reactstrap';
...
import { getUsers as onGetUsers, addNewUser as onAddNewUser, updateUser as onUpdateUser, deleteUser as onDeleteUser } from 'store/contacts/actions';
...
const ContactsList = (props) => {
  ...
  const onPaginationPageChange = (page) => {
    if (node && node.current && node.current.props && node.current.props.pagination && node.current.props.pagination.options) {
                        ...
                        <Row form>
                          <Col xs={12}>
                            ...
                            <div className="mb-3">
                              ...
                              />
                              {validation.touched.designation && validation.errors.designation ? <FormFeedback type="invalid">{validation.errors.designation}</FormFeedback> : null}
                            </div>
                            <div className="mb-3">
                            ...
                            <div className="mb-3">
                              ...
                              <Input
                                ...
                                invalid={validation.touched.tags && validation.errors.tags ? true : false}
                              >
                            ...
                            <div className="mb-3">
                              ...
                              <Input
                                ...
                                invalid={validation.touched.projects && validation.errors.projects ? true : false}
                              />
                              {validation.touched.projects && validation.errors.projects ? <FormFeedback type="invalid">{validation.errors.projects}</FormFeedback> : null}
                            </div>
                          </Col>
                        </Row>
                        <Row>
