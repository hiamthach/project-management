                  ...
                  <div className="d-flex flex-column h-100">
                          ...
                          <div className="mt-4 text-center">
                            ...
                            <ul className="list-inline">
                              <li className="list-inline-item">
                                <Link to="#" className="social-list-item bg-primary text-white border-primary me-1">
                                  <i className="mdi mdi-facebook"></i>
                                </Link>
                              </li>
                              <li className="list-inline-item">
                                <Link to="#" className="social-list-item bg-info text-white border-info me-1">
                    ...
                    <div className="mt-4 mt-md-5 text-center">
                      <p className="mb-0">
                        ...
                        Skote. Crafted with <i className="mdi mdi-heart text-danger"></i> by Themesbrand
                      </p>
                    </div>
                  </div>
                </div>
