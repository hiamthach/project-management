            ...
            <Row>
              <Col lg="4">
                <div className="text-lg-center">
                  {data.image ? (
                    <img src={images[data.image]} className="avatar-sm me-3 mx-lg-auto mb-3 mt-1 float-start float-lg-none rounded-circle" alt="img" />
                  ) : (
                    <div className="avatar-sm me-3 mx-lg-auto mb-3 mt-1 float-start float-lg-none rounded-circle">
                      <span className={'avatar-title rounded-circle bg-soft bg-' + data.color + ' text-primary font-size-16'}>{nameIcon}</span>
                    </div>
                  )}
              ...
              <Col lg="8">
                <div>
                  <Link to={'/invoices-detail/' + data.id} className="d-block text-primary text-decoration-underline mb-2">
