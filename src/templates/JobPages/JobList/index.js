...
import TableContainer from '../../../theme/Common/TableContainer';
...
import DeleteModal from '../../../theme/Common/DeleteModal';

import { getJobList as onGetJobList, addNewJobList as onAddNewJobList, updateJobList as onUpdateJobList, deleteJobList as onDeleteJobList } from 'store/actions';
...
function JobList() {
  ...
  return (
    <React.Fragment>
      <DeleteModal show={deleteModal} onDeleteClick={handleDeletejob} onCloseClick={() => setDeleteModal(false)} />
                ...
                <CardBody className="border-bottom">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="flex-shrink-0">
                      <Link to="#!" onClick={() => setModal(true)} className="btn btn-primary me-1">
                        Add New Job
                      </Link>
                  ...
                  <Col className="col-12">
                    <div className="mb-3">
                      ...
                      <Input
                        ...
                        invalid={validation.touched.jobId && validation.errors.jobId ? true : false}
                      />
                      {validation.touched.jobId && validation.errors.jobId ? <FormFeedback type="invalid">{validation.errors.jobId}</FormFeedback> : null}
                    </div>
                    <div className="mb-3">
                      ...
                      />
                      {validation.touched.jobTitle && validation.errors.jobTitle ? <FormFeedback type="invalid">{validation.errors.jobTitle}</FormFeedback> : null}
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                      ...
                      />
                      {validation.touched.location && validation.errors.location ? <FormFeedback type="invalid">{validation.errors.location}</FormFeedback> : null}
                    </div>
                    <div className="mb-3">
                      ...
                      <Input
                        ...
                        invalid={validation.touched.experience && validation.errors.experience ? true : false}
                      />
                      {validation.touched.experience && validation.errors.experience ? <FormFeedback type="invalid">{validation.errors.experience}</FormFeedback> : null}
                    </div>
                    <div className="mb-3">
                      ...
                      />
                      {validation.touched.position && validation.errors.position ? <FormFeedback type="invalid">{validation.errors.position}</FormFeedback> : null}
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                      ...
                      {validation.touched.status && validation.errors.status ? <FormFeedback status="invalid">{validation.errors.status}</FormFeedback> : null}
                    </div>
                  </Col>
                </Row>
                <Row>
