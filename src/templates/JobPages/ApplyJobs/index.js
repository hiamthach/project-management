...
import { getApplyJob as OnGetApplyJob, deleteApplyJob as OnDeleteApplyJob } from 'store/jobs/actions';
...
const ApplyJobs = () => {
  ...
  return (
    <React.Fragment>
      <DeleteModal show={deleteModal} onDeleteClick={() => handleDeleteApplyJob()} onCloseClick={() => setDeleteModal(false)} />
        ...
        <Container fluid>
          ...
          <Row>
            <Col lg="12">
              <Card>
                <CardBody>
                  <TableContainer columns={columns} data={jobApply} isGlobalFilter={true} isAddUserList={false} customPageSize={10} />
                </CardBody>
              </Card>
            </Col>
          </Row>
