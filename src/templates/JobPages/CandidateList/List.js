              ...
              <CardBody>
                ...
                <div className="d-flex mb-3 justify-content-center gap-2 text-muted">
                  ...
                  <p className="mb-0 text-center">
                    <i className="bx bx-money align-middle text-primary"></i> ${item.experience} / hrs
                  </p>
                </div>
                <div className="hstack gap-2 justify-content-center">
                  {(item.skills || []).map((subItem, key) => (
                    <span key={key} className="badge badge-soft-secondary">
                      {subItem}
                    </span>
                  ))}
                </div>
                ...
                <div className="mt-4 pt-1">
                  <Link to="/candidate-overview" className="btn btn-soft-primary d-block">
                    View Profile
                  </Link>
                </div>
              </CardBody>
