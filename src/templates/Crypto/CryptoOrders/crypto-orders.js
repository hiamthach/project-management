...
import { Button, Card, CardBody, Col, Container, Form, FormGroup, Label, NavItem, NavLink, Row, TabContent, TabPane } from 'reactstrap';
                ...
                <CardBody>
                  ...
                  <TabContent activeTab={activeTab} className="p-3">
                    <TabPane tabId="1" id="all-order">
                        ...
                        <Row className="mb-4">
                          <Col sm={6} className="col-xl">
                            <FormGroup className="mb-3">
                              ...
                              <DatePicker onChange={handleChange} className="form-control" placeholderText="Select date" />
                            </FormGroup>
                          </Col>
                      ...
                      <TableContainer columns={columns} data={cryptoOrderData} isGlobalFilter={true} isAddOptions={false} customPageSize={10} />
                    </TabPane>
...
export default connect(mapStateToProps, mapDispatchToProps)(CryptoOrders);
