                                ...
                                <div className="mb-3">
                                  <label className="card-radio-label mb-2">
                                    ...
                                    <div className="card-radio">
                                      <div>
                                        <i className="mdi mdi-bitcoin font-size-24 text-warning align-middle me-2" /> <span>Bitcoin</span>
                                      </div>
                                    </div>
                                  </label>
                              ...
                              <Col xl="2" sm="4">
                                <div className="mb-3">
                                  <Label className="card-radio-label mb-2">
                                    ...
                                    <div className="card-radio">
                                      <div>
                                        <i className="mdi mdi-ethereum font-size-24 text-primary align-middle me-2" /> <span>Ethereum</span>
                                      </div>
                                    </div>
                                  </Label>
                              ...
                              <Col xl="2" sm="4">
                                <div className="mb-3">
                                  <Label className="card-radio-label mb-2">
                                    ...
                                    <div className="card-radio">
                                      <div>
                                        <i className="mdi mdi-litecoin font-size-24 text-info align-middle me-2" /> <span>litecoin</span>
                                      </div>
                                    </div>
                                  </Label>
                            ...
                            <Row>
                              <Col xl="2" sm="4">
                                <Label className="card-radio-label mb-3">
                                  ...
                                  <div className="card-radio">
                                    <i className="fab fa-cc-mastercard font-size-24 text-primary align-middle me-2" /> <span>Credit / Debit Card</span>
                                  </div>
                                </Label>
                              </Col>
                              ...
                              <Col xl="2" sm="4">
                                <Label className="card-radio-label mb-3">
                                  ...
                                  <div className="card-radio">
                                    <i className="fab fa-cc-paypal font-size-24 text-primary align-middle me-2" /> <span>Paypal</span>
                                  </div>
                                </Label>
                              </Col>
                            </Row>
