...
import { Nav, NavbarToggler, NavItem, NavLink, Container, Collapse } from 'reactstrap';
...
const Navbar_Page = (props) => {
  ...
  return (
    <React.Fragment>
      <nav className={'navbar navbar-expand-lg navigation fixed-top sticky ' + props.navClass}>
        <Container>
          ...
          <Collapse id="topnav-menu-content" isOpen={isOpenMenu} navbar>
            <ScrollspyNav scrollTargetIds={TargetId} scrollDuration="800" headerBackground="true" activeNavClass="active" className="navbar-collapse">
