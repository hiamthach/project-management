          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="ecommerce-product-detail/1">{props.t('Product Detail')}</Link>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="crypto-kyc-application">{props.t('KYC Application')}</Link>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  ...
                  <ul className="sub-menu">
                    <li>
                      <Link to="email-template-basic">{props.t('Basic Action')}</Link>
                    </li>
                    <li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="projects-overview">{props.t('Project Overview')}</Link>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="auth-email-verification">{props.t('Email Verification')}</Link>
                </li>
                <li>
                  <Link to="auth-email-verification-2">{props.t('Email Verification 2')}</Link>
                </li>
                <li>
                  <Link to="auth-two-step-verification">{props.t('Two Step Verification')}</Link>
                </li>
                <li>
                  <Link to="auth-two-step-verification-2">{props.t('Two Step Verification 2')}</Link>
                </li>
              </ul>
            </li>
            <li>
