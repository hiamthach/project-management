...
import NotificationDropdown from 'theme/CommonForBoth/TopbarDropdown/NotificationDropdown';
import ProfileMenu from 'theme/CommonForBoth/TopbarDropdown/ProfileMenu';
  ...
  return (
    <header id="page-topbar">
      <div className="navbar-header">
        ...
        <div className="d-flex navbar-align-center">
          <Link to="/project/add">
