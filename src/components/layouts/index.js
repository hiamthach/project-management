...
import RightSidebar from 'theme/CommonForBoth/RightSidebar';
...
const Layout = (props) => {
  ...
  const { leftSideBarThemeImage, layoutWidth, leftSideBarType, topbarTheme, showRightSidebar, leftSideBarTheme, layoutModeType } = useSelector((state) => ({
