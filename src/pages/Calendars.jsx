            ...
            <Col className="col-12">
              <Row>
                      ...
                      <div id="external-events" className="mt-2">
                        ...
                        {categories &&
                          categories.map((category, i) => (
                            <div className={`${category.type} external-event fc-event text-white`} key={'cat-' + category.id} draggable onDrag={(event) => onDrag(event, category)}>
                ...
                <Col className="col-lg-9">
                    ...
                    <ModalBody className="p-4">
                      ...
                      >
                        ...
                        <Row className="mt-2">
                          <Col className="col-6">
                            {!!isEdit && (
                              <button type="button" className="btn btn-danger me-2" onClick={() => setDeleteModal(true)}>
                                Delete
                              </button>
                            )}
                          </Col>
                  ...
                  <Modal isOpen={modalcategory} toggle={toggleCategory} className={props.className} centered>
                    ...
                    <ModalBody className="p-4">
                      ...
                      >
                        ...
                        <Row className="mt-2">
                          ...
                          <Col className="col-6 text-end">
                            <button type="button" className="btn btn-light me-1" onClick={toggleCategory}>
                              Close
                            </button>
                            <button type="submit" className="btn btn-success" id="btn-save-event">
                              Save
